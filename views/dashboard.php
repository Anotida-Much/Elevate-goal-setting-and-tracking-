...
<body>
  ...
  <div class="main-content container-fluid">
    <div class="m-4">
          ...
          <div class="row gy-4 d-flex justify-content-center">
            ...
            <div class="col-xl-3 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="100">
              <div class="w-100 p-3 border rounded shadow-sm statistics-card">
                <span id="goals-set"
                  class="badge bg-secondary position-relative float-end rounded-pill p-3 ms-2">00</span>
            ...
            <div class="col-xl-3 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="200">
              <div class="w-100 p-3 border rounded shadow-sm statistics-card">
                <span id="goals-achieved"
                  class="badge bg-success position-relative float-end rounded-pill p-3 ms-2">00</span>
                <div class="row shadow-lg">
            ...
            <div class="col-xl-3 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="300">
              <div class="w-100 p-3 border rounded shadow-sm statistics-card">
                <span id="goals-missed"
                  class="badge bg-danger position-relative float-end rounded-pill p-3 ms-2">00</span>
                <div class="row shadow-lg">
            ...
            <div class="col-xl-4 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="400">
              <div class="w-100 p-3 border rounded shadow-sm statistics-card">
                <span id="goals-in-progress"
                  class="badge bg-info position-relative float-end rounded-pill p-3 ms-2">00</span>
                <div class="row shadow-lg">
            ...
            <div class="col-xl-4 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="500">
              <div class="w-100  p-3 border rounded shadow-sm statistics-card">
                <span id="goals-on-hold"
                  class="badge bg-warning position-relative float-end rounded-pill p-3 ms-2">00</span>
                <div class="row shadow-lg">
      ...
      <!-- Top Three -->
      <section class="container-fluid border border-1 shadow-sm rounded-4 p-2 mb-3 bg-white">
