...
<body>
  ...
  <div class="main-content container-fluid">
    ...
    <!-- Goals Section -->
    <div class="container border border-1 shadow-sm rounded-4 p-2 mb-3 bg-white">
      ...
      <div class="container">
        <div class="row gy-4 d-flex justify-content-center">
          <div class="col-xl-3 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="50">
            <div class="w-100 p-3 border shadow-sm rounded statistics-card" id="current-time">
              <div class="row d-flex align-items-center justify-content-between">
                <div class="col-auto"><i class="bi bi-calendar-plus icon text-primary"></i></div>
                <h5 class="col-auto">Today</h5>
                <p class="col-auto badge bg-primary position-relative float-end" id="today"></p>
              </div>
              <div id="date-info">
              </div>
              <hr>
          ...
          <div class="col-xl-3 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="100">
            <div class="w-100 p-3 border rounded shadow-sm statistics-card">
              <span id="goals-set" class="badge bg-secondary position-relative float-end rounded-pill p-3 ms-2">00</span>
          ...
          <div class="col-xl-3 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="200">
            <div class="w-100 p-3 border rounded shadow-sm statistics-card">
              <span id="goals-achieved" class="badge bg-success position-relative float-end rounded-pill p-3 ms-2">00</span>
              <div class="row shadow-lg">
          ...
          <div class="col-xl-3 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="300">
            <div class="w-100 p-3 border rounded shadow-sm statistics-card">
              <span id="goals-missed" class="badge bg-danger position-relative float-end rounded-pill p-3 ms-2">00</span>
              <div class="row shadow-lg">
          ...
          <div class="col-xl-4 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="400">
            <div class="w-100 p-3 border rounded shadow-sm statistics-card">
              <span id="goals-in-progress" class="badge bg-info position-relative float-end rounded-pill p-3 ms-2">00</span>
              <div class="row shadow-lg">
          ...
          <div class="col-xl-4 col-sm-6 col-md-4 d-flex" data-aos="flip-right" data-aos-delay="500">
            <div class="w-100  p-3 border rounded shadow-sm statistics-card">
              <span id="goals-on-hold" class="badge bg-warning position-relative float-end rounded-pill p-3 ms-2">00</span>
              <div class="row shadow-lg">
    ...
    <!-- Top Three -->
    <section class="container border border-1 shadow-sm rounded-4 p-2 mb-3 bg-white">
      <div class="section-title">
        <h3 class="text-primary">Upcoming Deadlines: Top 3 Goals</h3>
    ...
    <!-- Motivation Section -->
    <section id="motivation" class="motivation container border border-1 shadow-sm rounded-4 p-2 mb-3 bg-white">
    ...
    <!-- CTA Section -->
    <section class="cta-section bg-primary text-white border border-1 shadow-sm p-2 mb-3">
      <div class="container">
