                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="goal-progress-notify">Goal Progress Notifications</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="account-security-notify" checked>
                          <label class="form-check-label" for="account-security-notify">Account & Security Notifications</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="engagement-notify" checked>
                          <label class="form-check-label" for="engagement-notify">Engagement & Motivational Notifications</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="administrative-notify" checked disabled>
                          <label class="form-check-label" for="administrative-notify">Administrative Notifications</label>
                        </div>
                      </div>
                    </div>
                    <div class="text-center">
